...
ItemDatabase::ItemDatabase()
{
    ...
    templates_ = {
        ...
        { 100, "アイアンソード",       "鍛冶屋の定番。癖がなく扱いやすい。",       EquipSlot::Weapon, SWD, 1, WeaponStats(28.0f, 0.05f, 0.10f, 0.00f) },
        { 101, "ブレイズエッジ",       "刃に熱を宿した中級剣。",                   EquipSlot::Weapon, SWD, 2, WeaponStats(44.0f, 0.07f, 0.14f, 0.02f) },
        { 102, "エクリプス・ブレード", "蝕の夜にのみ研がれるという長剣。",         EquipSlot::Weapon, SWD, 3, WeaponStats(62.0f, 0.09f, 0.20f, 0.04f) },

        //--- 片手棍 : 高火力・低速 ----------------------------------------------
        { 110, "アイアンメイス",       "重量で叩き潰す打撃武器。",                 EquipSlot::Weapon, MCE, 1, WeaponStats(35.0f, 0.03f, 0.16f, -0.10f) },
        { 111, "ルーンクラブ",         "古代文字が刻まれた棍棒。",                 EquipSlot::Weapon, MCE, 2, WeaponStats(53.0f, 0.04f, 0.20f, -0.08f) },
        { 112, "蝕の戦槌",             "一撃で城門をも砕くと伝わる。",             EquipSlot::Weapon, MCE, 3, WeaponStats(74.0f, 0.05f, 0.26f, -0.06f) },

        //--- 短剣 : 手数とクリティカル ------------------------------------------
        { 120, "ショートダガー",       "懐に隠せる小振りの刃。",                   EquipSlot::Weapon, DGR, 1, WeaponStats(20.0f, 0.16f, 0.14f, 0.18f, 12.0f) },
        { 121, "シャドウファング",     "影を裂く牙。連撃に長ける。",               EquipSlot::Weapon, DGR, 2, WeaponStats(31.0f, 0.20f, 0.18f, 0.22f, 16.0f) },
        { 122, "蝕の牙",               "闇に紛れて急所を貫く。",                   EquipSlot::Weapon, DGR, 3, WeaponStats(43.0f, 0.24f, 0.24f, 0.26f, 20.0f) },

        //--- 細剣 : 高速・刺突 ---------------------------------------------------
        { 130, "フルーレ",             "軽量の刺突剣。初心者にも扱える。",         EquipSlot::Weapon, RPR, 1, WeaponStats(24.0f, 0.11f, 0.12f, 0.12f, 8.0f) },
        { 131, "ウィンドピアサー",     "風を裂く速度の細剣。",                     EquipSlot::Weapon, RPR, 2, WeaponStats(37.0f, 0.14f, 0.16f, 0.15f, 12.0f) },
        { 132, "蝕の刺剣",             "一点に集約された蝕の光を放つ。",     EquipSlot::Weapon, RPR, 3, WeaponStats(51.0f, 0.17f, 0.22f, 0.18f, 16.0f) },

        //--- 槍 : 長射程 ---------------------------------------------------------
        { 140, "アイアンランス",       "間合いを制する長柄武器。",                 EquipSlot::Weapon, SPR, 1, WeaponStats(31.0f, 0.06f, 0.12f, -0.04f) },
        { 141, "ストームパイク",       "突きの衝撃が空気を裂く。",                 EquipSlot::Weapon, SPR, 2, WeaponStats(47.0f, 0.08f, 0.16f, -0.02f) },
        { 142, "蝕の穿槍",             "届かぬものなしと謳われた穂先。",           EquipSlot::Weapon, SPR, 3, WeaponStats(66.0f, 0.10f, 0.22f,  0.00f) },
        ...
        { 202, "月光のサークレット",   "MP の巡りを良くする装飾。",                 EquipSlot::Head, SWD, 2, ArmorStats(8.0f,  45.0f, 38.0f, 0.02f, 0.0f, 1.2f) },
        ...
        { 212, "月光のコート",         "魔力を織り込んだ外套。",                   EquipSlot::Body, SWD, 2, ArmorStats(15.0f, 100.0f, 52.0f, 0.0f, 10.0f, 1.6f) },
